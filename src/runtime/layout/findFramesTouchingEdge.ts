...
import { type Direction, type Edge, type EdgeSide, type LayoutFrame, type Point } from "../types/index.js"

/**
 * Given an edge or visualEdge (which might touch/contain several frame edges), returns the frame edges that match the given criteria. If no criteria is given, just returns all touching frames.
 *
...
): ({ edge: Edge, frame: LayoutFrame, side: EdgeSide })[] | undefined {
